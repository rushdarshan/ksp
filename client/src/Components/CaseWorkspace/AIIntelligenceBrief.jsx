...
export default function AIIntelligenceBrief() {
  ...
  const exportPDF = () => {
    ...
    printWindow.document.write('body { font-family: Inter, sans-serif; color: #0a0a0a; padding: 32px; max-width: 800px; margin: 0 auto; }');
    ...
    printWindow.document.write('.aib__para { margin: 0 0 8px; padding: 8px 12px; background: #f8fafc; border-left: 3px solid #b8860b; font-size: 13px; }');
    ...
    printWindow.document.write('.aib__reco { padding: 8px 12px; background: #f8fafc; border-left: 3px solid; margin-bottom: 6px; font-size: 13px; }');
    ...
    printWindow.document.write('.aib__vflag { padding: 6px 10px; margin-bottom: 4px; font-size: 12px; border-left: 3px solid; }');
    ...
    printWindow.document.write('.aib__reco-note { font-size: 12px; color: #6b6b6b; padding: 6px 10px; border-left: 3px solid #b8860b; margin-top: 8px; }');
