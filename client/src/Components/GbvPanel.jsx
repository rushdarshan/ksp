        ...
        <div className="panel" style={{ padding: '20px', maxWidth: '1000px' }}>
            ...
            <div style={{ display: 'flex', gap: '8px', marginBottom: '20px' }}>
                <button onClick={() => { setActiveTab('overview'); loadAnalytics(); }}
                    style={{ padding: '8px 16px', background: activeTab === 'overview' ? '#be185d' : '#f8fafc', color: activeTab === 'overview' ? 'white' : '#333', border: '1px solid #d1d5db', borderRadius: '6px', cursor: 'pointer', fontWeight: 600, fontSize: '13px' }}>
                    Overview
                </button>
                <button onClick={() => { setActiveTab('resources'); loadResources(); }}
                    style={{ padding: '8px 16px', background: activeTab === 'resources' ? '#be185d' : '#f8fafc', color: activeTab === 'resources' ? 'white' : '#333', border: '1px solid #d1d5db', borderRadius: '6px', cursor: 'pointer', fontWeight: 600, fontSize: '13px' }}>
                    Support Resources
                </button>
            </div>
                ...
                <>
                    <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px', marginBottom: '20px' }}>
                        ...
                        <div style={{ padding: '16px', background: '#fdf2f8', borderRadius: '10px', textAlign: 'center' }}>
                            ...
                            <div style={{ fontSize: '28px', fontWeight: 700, color: data.summary.changePercent > 0 ? '#dc2626' : '#22c55e' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '20px' }}>
                        {data.repeatVictims.length > 0 && (
                            <div style={{ padding: '16px', background: '#fef2f2', borderRadius: '10px', border: '1px solid #fecaca' }}>
                                <div style={{ fontWeight: 600, marginBottom: '8px', color: '#dc2626' }}>Repeat GBV Victims by District</div>
                    ...
                    <div>
                        ...
                        <div style={{ display: 'grid', gap: '8px' }}>
                            {resources.laws.map((l, i) => (
                                <div key={i} style={{ padding: '10px 14px', background: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
